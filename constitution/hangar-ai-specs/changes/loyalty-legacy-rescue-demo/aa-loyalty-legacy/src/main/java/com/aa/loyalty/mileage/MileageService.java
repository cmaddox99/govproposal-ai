...
public class MileageService {
    ...
    @Autowired
    private com.aa.loyalty.notification.NotificationService notificationService;
    ...
    public boolean redeemMiles(String memberNumber, long milesRequested, String redemptionType, String description) {
        ...
        try {
            notificationService.sendRedemptionConfirmationEmail(memberNumber, milesRequested, redemptionType);
        } catch (Exception e) {
            LOG.warning("Redemption notification failed: " + e.getMessage());
        }

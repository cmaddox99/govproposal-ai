...
public class MileageController {
    ...
    public ResponseEntity<Object> getBalance(@PathVariable String memberNumber) {
    ...
    public ResponseEntity<Object> accrueFlightMiles(
    ...
    public ResponseEntity<Object> redeemMiles(
            @PathVariable String memberNumber,
    ...
    public ResponseEntity<Object> adminAdjust(
